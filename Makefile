...
# hws.io/hws-operator-bundle:$VERSION and hws.io/hws-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= hws.io/hws-operator

# BUNDLE_IMG defines the image:tag used for the bundle.
# You can use it as an arg. (E.g make bundle-build BUNDLE_IMG=<some-registry>/<project-name-bundle>:<tag>)
BUNDLE_IMG ?= quay.io/mohamedf0/hws-operator-bundle:$(VERSION)
...
IMG ?= quay.io/mohamedf0/hws-operator:$(VERSION)
